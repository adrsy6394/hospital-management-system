          ...
          {loading ? (
            ...
            <div className="divide-y divide-gray-200">
              {filteredAppointments.map((appointment) => (
                <div key={appointment._id} className="p-6 hover:bg-gray-50 transition">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                          ...
                          <p className="text-base text-gray-900">{appointment.symptoms || 'N/A'}</p>
                        </div>
                      </div>
                      ...
                      {appointment.diagnosis && (
                        <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                          ...
                          <p className="text-sm text-blue-800 mt-1">{appointment.diagnosis}</p>
                        </div>
                      )}
                    </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-gray-500 font-medium">{selectedAppointment.appointmentId}</p>
              </div>
              <button 
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-4">
                <section>
                  ...
                  <div className="mt-1">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold capitalize ${getStatusColor(selectedAppointment.status)}`}>
                ...
                <section>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Doctor Name</label>
                  <p className="text-lg font-semibold text-gray-900">
              ...
              <div className="space-y-4">
                <section>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Appointment Date</label>
                  <p className="text-lg font-semibold text-gray-900">
                ...
                <section>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Scheduled Time</label>
                  <p className="text-lg font-semibold text-gray-900">
                    {selectedAppointment.timeSlot?.startTime} - {selectedAppointment.timeSlot?.endTime}
                  </p>
                </section>
                <section>
                  <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Symptoms</label>
                  <p className="text-gray-700 italic border-l-4 border-blue-200 pl-4 py-1">
            ...
            {selectedAppointment.diagnosis && (
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <h4 className="text-sm font-bold text-blue-900 uppercase tracking-wider mb-2">Final Diagnosis</h4>
                <p className="text-blue-800 leading-relaxed">{selectedAppointment.diagnosis}</p>
              </div>
            )}
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
              <button 
                onClick={() => setShowDetailsModal(false)}
                className="px-8 py-3 bg-gray-900 text-white rounded-xl hover:bg-black transition font-semibold"
              >
                Close Details
              </button>
            </div>
