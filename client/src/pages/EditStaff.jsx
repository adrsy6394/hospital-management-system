    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Update staff professional duties and information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 border-b pb-2">Personal Information (Read-Only)</h2>
            <p className="text-sm text-gray-500 mb-2">Core contact details can only be changed by the user.</p>
